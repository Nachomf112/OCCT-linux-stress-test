...
Herramienta en Bash inspirada en OCCT para **probar la estabilidad de tu equipo en Linux** (CPU y RAM) y generar un informe rápido con la información más importante del sistema y de la prueba.
...
- 🔥 **Stress test de CPU y memoria RAM**
  ...
  - Usa herramientas clásicas de estrés en Linux (por ejemplo `stress` o `stress-ng`).
